            ...
            <div class="row grid grid-float pt-2 banner-grid mb-9 appear-animate">
                <div class="grid-item col-lg-6 height-x2">
                    <div class="banner banner-fixed banner-lg br-sm">
                        <figure>
                            <img src="/front_template/images/demos/demo9/banner/1-1.jpg" alt="Banner" width="670"
                ...
                <div class="grid-item col-lg-6 height-x1">
                    <div class="banner banner-fixed banner-md br-sm">
                        <figure>
                            <img src="/front_template/images/demos/demo9/banner/1-2.jpg" alt="Banner" width="670"
                ...
                <div class="grid-item col-sm-6 col-lg-3 height-x1">
                    <div class="banner banner-fixed banner-sm br-sm">
                        <figure>
                            <img src="/front_template/images/demos/demo9/banner/1-3.jpg" alt="Banner" width="330"
                ...
                <div class="grid-item col-sm-6 col-lg-3 height-x1">
                    <div class="banner banner-fixed banner-sm br-sm">
                        <figure>
                            <img src="/front_template/images/demos/demo9/banner/1-4.jpg" alt="Banner" width="330"
                    ...
                    <h2 class="title">{{$item_menu_parent['titre']}}</h2>
                        ...
                        <ul class="nav-filters" data-target="#products-{{$item_menu_parent['id']}}">
                            ...
                            @foreach($item_menu_parent->enfants as $item_categorie)
                                <li><a href="#" class="nav-filter" data-filter=".1-{{$item_categorie['id']}}">{{$item_categorie['titre']}}</a></li>
                            @endforeach
                        </ul>
                </div>
                                    ...
                                    <div class="product-details">
                                        ...
                                        <div class="product-price">
                                            @if( $item_article['prix_promo'] !=null &&  !empty($item_article['prix']) )
                                                <ins class="new-price"> {{$item_article['prix_promo']}} F </ins>
                                                <del class="old-price">  {{$item_article['prix']}} F </del>
                                            @else
                                                <ins class="new-price"> {{$item_article['prix']}} F </ins>
                                            @endif
                                        </div>
                                    </div>
                                </div>
