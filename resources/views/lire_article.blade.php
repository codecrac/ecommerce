...
<!-- Mirrored from portotheme.com/html/wolmart/product-vertical.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 16 Jul 2021 04:40:55 GMT -->
<head>
    <meta charset="UTF-8">
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/png" href="/front_template/images/icons/favicon.png">
    ...
    <script>
        ...
        (function (d) {
            ...
            wf.src = '/front_template/js/webfont.js';
            wf.async = true;
    ...
    <link rel="stylesheet" type="text/css" href="/front_template/vendor/photoswipe/default-skin/default-skin.min.css">
            ...
            <div class="container">
                <div class="header-left mr-md-4">
                    ...
                    <a href="demo1.html" class="logo ml-lg-0">
                        <img src="/front_template/images/logo.png" alt="logo" width="144" height="45" />
                    </a>
                                        ...
                                        <ul class="megamenu">
                                            ...
                                            <li>
                                                <div class="banner-fixed menu-banner menu-banner2">
                                                    <figure>
                                                        <img src="/front_template/images/menu/banner-2.jpg" alt="Menu Banner"
                                        ...
                                        <ul class="megamenu">
                                            ...
                                            <li>
                                                <div class="menu-banner banner-fixed menu-banner3">
                                                    <figure>
                                                        <img src="/front_template/images/menu/banner-3.jpg" alt="Menu Banner"
                                        ...
                                        <ul class="megamenu">
                                            ...
                                            <li>
                                                <div class="menu-banner banner-fixed menu-banner4">
                                                    <figure>
                                                        <img src="/front_template/images/menu/banner-4.jpg" alt="Menu Banner"
                                            ...
                                            <li class="row">
                                                <div class="col-6">
                                                    <div class="banner banner-fixed menu-banner5 br-xs">
                                                        <figure>
                                                            <img src="/front_template/images/menu/banner-5.jpg" alt="Banner"
                                                ...
                                                <div class="col-6">
                                                    <div class="banner banner-fixed menu-banner5 br-xs">
                                                        <figure>
                                                            <img src="/front_template/images/menu/banner-6.jpg" alt="Banner"
                                                                 width="410" height="123"
            ...
            <ul class="product-nav list-style-none">
                <li class="product-nav-prev">
                    ...
                    <span class="product-nav-popup">
                            <img src="/front_template/images/products/product-nav-prev.jpg" alt="Product" width="110"
                                 height="110" />
                ...
                <li class="product-nav-next">
                    ...
                    <span class="product-nav-popup">
                            <img src="/front_template/images/products/product-nav-next.jpg" alt="Product" width="110"
                                 height="110" />
                            ...
                            <div class="col-md-6 mb-6">
                                <div class="product-gallery product-gallery-sticky product-gallery-vertical">
                                    <div
                                        ...
                                        <figure class="product-image">
                                            <img src="/front_template/images/products/vertical_thumb/2-800x900.jpg"
                                                 data-zoom-image="/front_template/images/products/vertical_thumb/2-800x900.jpg"
                                                 alt="Professsional Camera Set" width="488" height="549">
                                        </figure>
                                        <figure class="product-image">
                                            <img src="/front_template/images/products/vertical_thumb/3-800x900.jpg"
                                                 data-zoom-image="/front_template/images/products/vertical_thumb/3-800x900.jpg"
                                                 alt="Professsional Camera Set" width="800" height="900">
                                        </figure>
                                        <figure class="product-image">
                                            <img src="/front_template/images/products/vertical_thumb/4-800x900.jpg"
                                                 data-zoom-image="/front_template/images/products/vertical_thumb/4-800x900.jpg"
                                                 alt="Professsional Camera Set" width="800" height="900">
                                        </figure>
                                    </div>
                                ...
                                @foreach($de_la_meme_categorie as $item)
                                    ...
                                    <figure class="product-media">
                                        ...
                                        <div class="product-action">
                                            <a href="#" class="btn-product btn-quickview" title="Quick View"> Aperçu </a>
                                        </div>
                                    </figure>
                                    <div class="product-details">
                                        <h4 class="product-name"><a href="product-default.html">{{$item['titre']}}</a></h4>
                                        <div class="product-pa-wrapper">
                                            <div class="product-price">{{$item['prix']}} F</div>
                                        </div>
                                    </div>
                                </div>
                                @endforeach
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="widget widget-about">
                            <a href="demo1.html" class="logo-footer">
                                <img src="/front_template/images/logo_footer.png" alt="logo-footer" width="144"
                                     height="45" />
                            </a>
            ...
            <div class="footer-bottom">
                ...
                <div class="footer-right">
                    ...
                    <figure class="payment">
                        <img src="/front_template/images/payment.png" alt="payment" width="159" height="25" />
                    </figure>
                </div>
            </div>
        </div>
        ...
        <div class="dropdown-box">
            <div class="products">
                <div class="product product-cart">
                    ...
                    <figure class="product-media">
                        <a href="#">
                            <img src="/front_template/images/cart/product-1.jpg" alt="product" height="84" width="94" />
                        </a>
                    </figure>
                    <button class="btn btn-link btn-close">
                        <i class="fas fa-times"></i>
                ...
                <div class="product product-cart">
                    ...
                    <figure class="product-media">
                        <a href="#">
                            <img src="/front_template/images/cart/product-2.jpg" alt="product" width="84" height="94" />
                        </a>
                    </figure>
                    <button class="btn btn-link btn-close">
                        <i class="fas fa-times"></i>
...
<script src="/front_template/vendor/zoom/jquery.zoom.min.js"></script>
<script src="/front_template/vendor/photoswipe/photoswipe.min.js"></script>
<script src="/front_template/vendor/photoswipe/photoswipe-ui-default.min.js"></script>
...
<!-- Mirrored from portotheme.com/html/wolmart/product-vertical.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 16 Jul 2021 04:40:57 GMT -->
</html>
