        ...
        <td style="word-break: break-word; vertical-align: top;" valign="top">
                            ...
                            <div class="col_cont" style="width:100% !important;">
                                ...
                                <div
                                    ...
                                    <div align="left" class="img-container left fullwidthOnMobile fixedwidth"
                                        ...
                                        <img alt="Image" border="0" class="left fullwidthOnMobile fixedwidth"
                                             src="http://{{$_SERVER['SERVER_NAME']}}:{{$_SERVER['SERVER_PORT']}}{{Storage::url($infos_generales['logo'])}}"
                                             style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: 0; width: 195px; max-width: 100%; display: block;"
            ...
            <div style="background-color:transparent;">
                <div class="block-grid"
                    ...
                    @php $bg = "http://".$_SERVER['SERVER_NAME'].':'.$_SERVER['SERVER_PORT'] . Storage::url($infos_generales['banniere']); @endphp
                    <div
                        style="border-collapse: collapse;display: table;width: 100%;background-color:#D6E7F0;background-image:url({{$bg}});background-position:top center;background-repeat:no-repeat">
                        <!--[if (mso)|(IE)]>
                        <table width="100%" cellpadding="0" cellspacing="0" border="0"
                               style="background-color:transparent;">
                            <tr>
                        ...
                        <td align="center" width="650"
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    <td style="padding-right: 0px; padding-left: 0px; padding-top:55px; padding-bottom:60px;">
                        <![endif]-->
                        <div class="col num12"
                             style="min-width: 320px; max-width: 650px; display: table-cell; vertical-align: top; width: 650px;">
                            <div class="col_cont" style="width:100% !important;">
                                ...
                                <div
                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                        <tr>
                                            <td style="padding-right: 10px; padding-left: 15px; padding-top: 20px; padding-bottom: 5px; font-family: Tahoma, Verdana, sans-serif">
                                    <![endif]-->
                                    <div
                                        ...
                                        <div class="txtTinyMce-wrapper"
                                            ...
                                            <p style="margin: 0; font-size: 38px; line-height: 1.2; text-align: center; word-break: break-word; mso-line-height-alt: 46px; margin-top: 0; margin-bottom: 0;">
                                                <span style="font-size: 38px;">
                                                    <strong>
                                                            <span
                                                                style="font-size: 38px; color: #fff;background-color: rgba(0,0,0,0.6);padding:25px"> {{$infos_generales['organisation']}}</span></span>
                                                </strong>
                                                </span>
                                            </p>
                                        </div>
                                    ...
                                    <div
                                        ...
                                        <div class="txtTinyMce-wrapper"
                                             style="font-size: 12px; line-height: 1.2; font-family: Lato, Tahoma, Verdana, Segoe, sans-serif; color: #052D3D; mso-line-height-alt: 14px;">
                                          {{--  <p style="margin: 0; font-size: 22px; line-height: 1.2; text-align: center; word-break: break-word; mso-line-height-alt: 26px; margin-top: 0; margin-bottom: 0;">
                                                <span style="font-size: 22px;"><strong><span style="font-size: 22px;"> Reference commande : #{{$la_commande['id']}} </span></strong></span>
                                            </p>--}}
                                        </div>
                                    </div>
                                    <!--[if mso]></td></tr></table><![endif]-->
                                ...
                                <div
                                    ...
                                    <div
                                        ...
                                        <div class="txtTinyMce-wrapper"
                                            ...
                                            <p style="padding:8px;border: 1px solid #000;margin: 0; line-height: 1.2; text-align: center; font-size: 20px; word-break: break-word; mso-line-height-alt: 24px; margin-top: 0; margin-bottom: 0;">
                                                <span style="font-size: 20px;"> Resumé de votre commande </span></p>
                                        </div>

                                        {{--            RESUME DE LA COMMANDE--}}
                                        <table style="border: 1px dashed #ccc;padding: 14px;margin-top: 10px">
                                            <tbody>
                                            <tr style="border: 1px dashed #ccc;padding: 14px;">
                                                <td style="border: 1px dashed #ccc;padding: 14px;"><label class="ls-25">Reference
                                                        :</label></td>
                                                <td style="border: 1px dashed #ccc;padding: 14px;"><b
                                                        class="amount">#{{$la_commande['id']}}</b></td>
                                            </tr>
                                            <tr style="border: 1px dashed #ccc;padding: 14px;">
                                                <td style="border: 1px dashed #ccc;padding: 14px;"><label class="ls-25">Nombre
                                                        article :</label></td>
                                                <td style="border: 1px dashed #ccc;padding: 14px;"><b
                                                        class="amount">{{$la_commande['nb_article']}}</b></td>
                                            </tr>
                                            <tr style="border: 1px dashed #ccc;padding: 14px;">
                                                <td style="border: 1px dashed #ccc;padding: 14px;"><label class="ls-25">Valeur
                                                        Total :</label></td>
                                                <td style="border: 1px dashed #ccc;padding: 14px;"><b
                                                        class="amount">{{number_format($la_commande['valeur_total'],0,'',' ')}}
                                                        F</b></td>
                                            </tr>
                                            <tr style="border: 1px dashed #ccc;padding: 14px;">
                                                <td style="border: 1px dashed #ccc;padding: 14px;"><label class="ls-25">Etat
                                                        :</label></td>
                                                <td style="border: 1px dashed #ccc;padding: 14px;"><b class="amount"
                                                                                                      style="text-transform: uppercase;
                                                                                    padding: 9px;
                                                                                    background-color: #FFC74E;
                                                                                    color: #000;">
                                                        {{ str_replace('_',' ',$la_commande['etat']) }}
                                                    </b>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="border: 1px dashed #ccc;padding: 14px;"><label class="ls-25">Client
                                                        :</label></td>
                                                <td style="border: 1px dashed #ccc;padding: 14px;"><b
                                                        class="amount"> {{$la_commande->client->nom}} </b></td>
                                            </tr>
                                            <tr>
                                                <td style="border: 1px dashed #ccc;padding: 14px;"><label class="ls-25">Adresse
                                                        :</label></td>
                                                <td style="border: 1px dashed #ccc;padding: 14px;"><b
                                                        class="amount"> {{$la_commande->client->adresse}} </b></td>
                                            </tr>
            ...
            <div style="background-color:transparent;">
                <div class="block-grid four-up no-stack"
                     style="min-width: 320px; max-width: 650px; overflow-wrap: break-word; word-wrap: break-word; word-break: break-word; Margin: 0 auto; background-color: #F8F8F8;">
                    <div style="border-collapse: collapse;display: table;width: 100%;background-color:#F8F8F8;">
                        ...
                        <td align="center" width="162"
                            style="background-color:#F8F8F8;width:162px; border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid #E8E8E8;"
                            valign="top">
                            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    <td style="padding-right: 0px; padding-left: 0px; padding-top:15px; padding-bottom:5px;">
                        ...
                        <!--[if (mso)|(IE)]></td>
                        <td align="center" width="162"
                            style="background-color:#F8F8F8;width:162px; border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 1px dotted #E8E8E8;"
                            valign="top">
                            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    <td style="padding-right: 0px; padding-left: 0px; padding-top:15px; padding-bottom:5px;">
                        <![endif]-->
                        <div class="col num3"
                             style="display: table-cell; vertical-align: top; max-width: 320px; min-width: 162px; width: 161px;">
                            <div class="col_cont" style="width:100% !important;">
                                <!--[if (!mso)&(!IE)]><!-->
                                <div
                        ...
                        <td align="center" width="162"
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    <td style="padding-right: 15px; padding-left: 15px; padding-top:15px; padding-bottom:5px;">
                        <![endif]-->
                        <div class="col num3"
                             style="display: table-cell; vertical-align: top; max-width: 320px; min-width: 162px; width: 161px;">
                            <div class="col_cont" style="width:100% !important;">
                        ...
                        <!--[if (mso)|(IE)]></td>
                        <td align="center" width="162"
                            style="background-color:#F8F8F8;width:162px; border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent;"
                            valign="top">
                            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    <td style="padding-right: 0px; padding-left: 0px; padding-top:15px; padding-bottom:5px;">
            ...
            @php $le_panier = json_decode($la_commande['panier']); @endphp

            @if(sizeof($le_panier))
                @foreach($le_panier as $item_article)
                <div class="block-grid four-up no-stack"
                     style="min-width: 320px; max-width: 650px; overflow-wrap: break-word; word-wrap: break-word; word-break: break-word; Margin: 0 auto; background-color: #FFFFFF;">
                    <div style="border-collapse: collapse;display: table;width: 100%;background-color:#FFFFFF;">
                        <!--[if (mso)|(IE)]>
                        ...
                        <!--[if (mso)|(IE)]>
                        <td align="center" width="162"
                            style="background-color:#FFFFFF;width:162px; border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent;"
                            valign="top">
                            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    <td style="padding-right: 0px; padding-left: 0px; padding-top:5px; padding-bottom:5px;">
                                ...
                                <div
                                    ...
                                    <div align="center" class="img-container center fixedwidth"
                                        ...
                                        <img align="center" alt="Image" border="0" class="center fixedwidth"
                                                         src="http://{{$_SERVER['SERVER_NAME']}}:{{$_SERVER['SERVER_PORT']}}{{Storage::url($item_article->image)}}"
                                                         style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: 0; width: 130px; max-width: 100%; display: block;"
                        ...
                        <!--[if (mso)|(IE)]></td>
                        <td align="center" width="162"
                            style="background-color:#FFFFFF;width:162px; border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 1px dotted #E8E8E8;"
                            valign="top">
                            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    <td style="padding-right: 0px; padding-left: 0px; padding-top:30px; padding-bottom:35px;">
                        <![endif]-->
                        <div class="col num3"
                             style="display: table-cell; vertical-align: top; max-width: 320px; min-width: 162px; width: 161px;">
                            <div class="col_cont" style="width:100% !important;">
                                ...
                                <div
                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                        <tr>
                                            <td style="padding-right: 10px; padding-left: 0px; padding-top: 10px; padding-bottom: 5px; font-family: Tahoma, Verdana, sans-serif">
                                    <![endif]-->
                                    <div
                                        ...
                                        <div class="txtTinyMce-wrapper"
                                             style="font-size: 12px; line-height: 1.2; font-family: Lato, Tahoma, Verdana, Segoe, sans-serif; color: #555555; mso-line-height-alt: 14px;">
                                            <p style="margin: 0; font-size: 16px; line-height: 1.2; text-align: left; word-break: break-word; mso-line-height-alt: 19px; margin-top: 0; margin-bottom: 0;">
                                                <span
                                                    style="font-size: 16px; color: #2190e3;"><strong>{{$item_article->titre}}</strong></span>
                                            </p>
                                        </div>
                                    </div>
                                    <!--[if mso]></td></tr></table><![endif]-->
                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                        <tr>
                                            <td style="padding-right: 10px; padding-left: 0px; padding-top: 0px; padding-bottom: 10px; font-family: Tahoma, Verdana, sans-serif">
                                    <![endif]-->
                                    <div
                        ...
                        <td align="center" width="162"
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    <td style="padding-right: 0px; padding-left: 0px; padding-top:55px; padding-bottom:5px;">
                        <![endif]-->
                        <div class="col num3"
                             style="display: table-cell; vertical-align: top; max-width: 320px; min-width: 162px; width: 161px;">
                            <div class="col_cont" style="width:100% !important;">
                                ...
                                <div
                                    ...
                                    <div
                                        ...
                                        <div class="txtTinyMce-wrapper"
                                             style="font-size: 12px; line-height: 1.2; font-family: Lato, Tahoma, Verdana, Segoe, sans-serif; color: #555555; mso-line-height-alt: 14px;">
                                            <p style="margin: 0; font-size: 20px; line-height: 1.2; text-align: center; word-break: break-word; mso-line-height-alt: 24px; margin-top: 0; margin-bottom: 0;">
                                                <span style="font-size: 20px;"><strong>2</strong></span></p>
                                        </div>
                                    </div>
                                    <!--[if mso]></td></tr></table><![endif]-->
                                    <table border="0" cellpadding="0" cellspacing="0" class="divider"
                        ...
                        <div class="col num3"
                            ...
                            <div class="col_cont" style="width:100% !important;">
                                ...
                                <div
                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                        <tr>
                                            <td style="padding-right: 15px; padding-left: 0px; padding-top: 0px; padding-bottom: 0px; font-family: Tahoma, Verdana, sans-serif">
                                    <![endif]-->
                                    <div
                                        style="color:#555555;font-family:Lato, Tahoma, Verdana, Segoe, sans-serif;line-height:1.2;padding-top:0px;padding-right:15px;padding-bottom:0px;padding-left:0px;">
                                        <div class="txtTinyMce-wrapper"
                                            ...
                                            <p style="margin: 0; line-height: 1.2; text-align: center; font-size: 20px; word-break: break-word; mso-line-height-alt: 24px; margin-top: 0; margin-bottom: 0;">
                                                <span style="font-size: 20px;"><span style="font-size: 20px;"><strong> {{number_format($item_article->prix,0,'',' ')}} F</strong></span></span>
                                            </p>
                                        </div>
                                    </div>
                                    <!--[if mso]></td></tr></table><![endif]-->
            ...
            <div style="background-color:transparent;">
                <div class="block-grid"
                     style="min-width: 320px; max-width: 650px; overflow-wrap: break-word; word-wrap: break-word; word-break: break-word; Margin: 0 auto; background-color: #F0F0F0;">
                    <div style="border-collapse: collapse;display: table;width: 100%;background-color:#F0F0F0;">
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" border="0"
                            ...
                            <tr>
                                <td align="center">
                                    <table cellpadding="0" cellspacing="0" border="0" style="width:650px">
                                        <tr class="layout-full-width" style="background-color:#F0F0F0"><![endif]-->
                        ...
                        <div class="col num12"
                            ...
                            <div class="col_cont" style="width:100% !important;">
                                ...
                                <div
                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                        <tr>
                                            <td style="padding-right: 15px; padding-left: 15px; padding-top: 15px; padding-bottom: 10px; font-family: Tahoma, Verdana, sans-serif">
                                    <![endif]-->
                                    <div
                                        ...
                                        <div class="txtTinyMce-wrapper"
                                             style="line-height: 1.2; font-size: 12px; font-family: Lato, Tahoma, Verdana, Segoe, sans-serif; color: #052d3d; mso-line-height-alt: 14px;">
                                            <p style="margin: 0; line-height: 1.2; font-size: 34px; text-align: center; word-break: break-word; mso-line-height-alt: 41px; margin-top: 0; margin-bottom: 0;">
                                                <span style="font-size: 34px;"><span
                                                        style="color: #fc7318; font-size: 34px;"><strong><span
                                                                style="font-size: 34px;"> {{$infos_generales['organisation']}} <br/></span></strong></span><span
                                                        style="font-size: 34px;"></span></span>
                                            </p>
                                        </div>
                                    </div>
                                    <!--[if mso]></td></tr></table><![endif]-->
                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                        <tr>
                                            <td style="padding-right: 10px; padding-left: 10px; padding-top: 0px; padding-bottom: 30px; font-family: Tahoma, Verdana, sans-serif">
                                    <![endif]-->
                                    <div
                                        ...
                                        <div class="txtTinyMce-wrapper"
                                            ...
                                            <p style="margin: 0; font-size: 18px; line-height: 1.5; text-align: center; word-break: break-word; mso-line-height-alt: 27px; margin-top: 0; margin-bottom: 0;">
                                                <span style="font-size: 18px;">{{$infos_generales['telephones']}} <br/> <strong><a
                                                            href="#" rel="noopener"
                                                            style="text-decoration: none; color: #2190E3;"
                                                            target="_blank">{{$infos_generales['email']}}</a></strong></span><br/><span
                                                    style="font-size: 18px;"> <span
                                                        style="color: #2190e3; font-size: 18px;"><strong></strong></span> <span
                                                        style="color: #2190e3; font-size: 18px;"><strong></strong></span> <br/><strong></strong></span>
                                            </p>
                                        </div>
                                    </div>
                                    <!--[if mso]></td></tr></table><![endif]-->
                                ...
                                <div
                                    ...
                                    <div
                                        ...
                                        <div class="txtTinyMce-wrapper"
                                            ...
                                            <p style="margin: 0; font-size: 14px; line-height: 1.5; text-align: center; word-break: break-word; mso-line-height-alt: 21px; margin-top: 0; margin-bottom: 0;">
                                                    ...
                                                    <tr style="vertical-align: top;" valign="top">
                                                        <td align="center"
                                                            ...
                                                            valign="top"><a href="https://www.designedwithbee.com/"><img
                                                                    ...
                                                                    height="32" src="images/bee.png" style="border:0;"
                                                                    width="null"/></a></td>
