...
@section('body')
    ...
    <div class="content-wrapper">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form method="post" action="{{route('modifier_evenement',[$levenement['id']])}}" enctype="multipart/form-data">
...
{{--                                <h4>Image Illustration <img src="data:image/jpeg;base64,{{$levenement['image']}}" width="100px" height="100px">  </h4>--}}
                                <h4>Image Illustration <img src="{{Storage::url($levenement['image'])}}" width="100px" height="100px">  </h4>
                        ...
                        <div class="form-group pt-3 col-12">
                            <div class="row">
                                ...
                                <input name="date_evenement" type="date" class="form-control"
                                       value="{{ date('Y-m-d',strtotime($levenement['date_evenement'])) }}" />
                            </div>
                        </div>
